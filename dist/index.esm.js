...
var templateObject_1$19, templateObject_2$w, templateObject_3$f;
...
var Icon$1u = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 256 256" }, props),
        React.createElement("image", { href: '/images/custom/btcd.png' })));
};
...
var templateObject_1$12, templateObject_2$v, templateObject_3$e, templateObject_4$9;
...
var templateObject_1$$, templateObject_2$u, templateObject_3$d, templateObject_4$8;
        ...
        React.createElement(Flex, { justifyContent: "flex-end" },
            ...
            switchEditingUnits && (React.createElement(Flex, { alignItems: "center", pl: "12px" },
                React.createElement(SwitchUnitsButton, { scale: "sm", variant: "text", onClick: switchEditingUnits },
                    React.createElement(Icon$W, { color: "textSubtle" })))))));
};
...
var templateObject_1$X, templateObject_2$s, templateObject_3$c, templateObject_4$7;
...
var FallingBunnies = function (_a) {
    ...
    var bunnies = __spreadArray([], Array(count)).map(function (_, index) { return (React.createElement(Bunny, { key: String(index), position: Math.random() * 100, iterations: iterations, duration: duration },
        React.createElement(Icon$1u, { width: size, height: size }))); });
...
var Icon$A = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 180 180" }, props),
        React.createElement("image", { href: '/images/guitarimg/loading.png' })));
};

var Icon$z = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 128 128" }, props, { display: "none" }),
...
var RotatingPancakeIcon = styled(Icon$z)(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
...
var StyledToggle = styled.div(templateObject_3$5 || (templateObject_3$5 = __makeTemplateObject(["\n  align-items: center;\n  // background-color: ", ";\n  background-color: ", "\n  border-radius: 24px;\n  box-shadow: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  height: ", ";\n  position: relative;\n  transition: background-color 200ms;\n  width: ", ";\n"], ["\n  align-items: center;\n  // background-color: ", ";\n  background-color: ", "\n  border-radius: 24px;\n  box-shadow: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  height: ", ";\n  position: relative;\n  transition: background-color 200ms;\n  width: ", ";\n"])), function (_a) {
    ...
    var theme = _a.theme, checked = _a.checked;
    return checked ? '#7ea192' : theme.colors.input;
}, function (_a) {
    var theme = _a.theme;
    return theme.shadows.inset;
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#6ccb9e", background: "#171e1b", backgroundDisabled: "#3c3742", backgroundAlt: "#0f1412", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#101613", inputSecondary: "#262130", primaryDark: "#0098A1", tertiary: "#252c29", text: "#93bdac", textDisabled: "#666171", textSubtle: "#939d99", disabled: "#524B63", gradients: {
        bubblegum: "linear-gradient(139.73deg, #111614 0%, #1e1e1e 100%)",
...
var ModalBackButton = function (_a) {
    ...
    return (React.createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
        React.createElement(Icon$27, { color: "primary" })));
};
...
var Icon$y = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 128 128" }, props),
        React.createElement("image", { width: 128, height: 128, href: "/images/custom/coinforensics.png" })));
};
...
var Icon$n = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24", width: 24, height: 24 }, props),
        React.createElement("path", { d: "M19 0H5a5 5 0 0 0-5 5v14a5 5 0 0 0 5 5h14a5 5 0 0 0 5-5V5a5 5 0 0 0-5-5zM8 19H5V8h3v11zM6.5 6.732c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zM20 19h-3v-5.604c0-3.368-4-3.113-4 0V19h-3V8h3v1.765c1.396-2.586 7-2.777 7 2.476V19z" })));
};
...
var Logo$2 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 1280 256" }, props),
        React.createElement("image", { href: isDark ? '/images/custom/site-logo.png' : '/images/custom/site-logo.png' })));
};
...
var Icon$a = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { href: '/images/guitarimg/contact.png' })));
};

var Icon$9 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { href: '/images/guitarimg/voting.png' })));
};

var Icon$8 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { href: '/images/guitarimg/blog.png' })));
};

var Icon$7 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { href: '/images/guitarimg/doc.png' })));
};

var Icon$6 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { href: '/images/guitarimg/psm.png' })));
};

var Icon$5 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { href: '/images/guitarimg/audit.png' })));
};

var Icon$4 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { href: '/images/guitarimg/partnership.png' })));
};

var Icon$3 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { href: '/images/guitarimg/ilo.png' })));
};

var Icon$2 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { href: '/images/guitarimg/link1.png' })));
};

var Icon$1 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { href: '/images/guitarimg/link2.png' })));
};

var Icon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("image", { href: '/images/guitarimg/link3.png' })));
};

var IconModule = /*#__PURE__*/Object.freeze({
    __proto__: null,
    CoinForensicsIcon: Icon$y,
    DiscordIcon: Icon$x,
    FacebookIcon: Icon$w,
    FarmIcon: Icon$v,
    GithubIcon: Icon$u,
    ...
    InfoIcon: Icon$o,
    LinkedinIcon: Icon$n,
    LiquidityIcon: Icon$m,
    LogoIcon: LogoWithText,
    MoonIcon: Icon$l,
    MoreIcon: Icon$k,
    NftIcon: Icon$j,
    PoolIcon: Icon$i,
    PredictionsIcon: Icon$1a,
    RedditIcon: Icon$h,
    SunIcon: Icon$g,
    ...
    TradeIcon: Icon$c,
    TwitterIcon: Icon$b,
    ContactusIcon: Icon$a,
    VotingIcon: Icon$9,
    BlogIcon: Icon$8,
    DocIcon: Icon$7,
    PsmIcon: Icon$6,
    AuditIcon: Icon$5,
    PartnershipIcon: Icon$4,
    IloIcon: Icon$3,
    Link1Icon: Icon$2,
    Link2Icon: Icon$1,
    Link3Icon: Icon
...
var Logo = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        React.createElement(Icon$1u, { className: "mobile-icon" }),
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        React.createElement(MenuEntry, { onClick: handleClick, className: className, isActive: isActive, role: "button" },
            ...
            isOpen ? React.createElement(Icon$24, null) : React.createElement(Icon$25, null)),
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, { href: "https://bscscan.com/token/0xEd11F2fBEae0E42b11fD784737E5186dEA4c43Df", target: "_blank" },
        React.createElement(Icon$1d, { width: "24px", mr: "12px" }),
...
var SocialLinks = function () { return (React.createElement(Flex, null, socials.map(function (social, index) {
    ...
    var iconProps = { width: index === 3 ? "25px" : "20px", color: "textSubtle", style: { cursor: "pointer" } };
...
var UserMenu = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(StyledUserMenu, __assign({ ref: setTargetRef }, props),
            ...
            React.createElement(Icon$1O, { color: "text", width: "24px" })),
...
var MoreWalletCard = function (props) {
    return (React.createElement(WalletButton, __assign({ variant: "tertiary" }, props),
        React.createElement(Icon$1j, { width: "40px", mb: "8px", color: "textSubtle" }),
    ...
    return (React.createElement(ModalContainer, { minWidth: "320px" },
        ...
        React.createElement(ModalBody, { width: ["320px", null, "340px"] },
            ...
            React.createElement(Box, { p: "24px" },
                ...
                React.createElement(Button, __assign({ as: "a", href: "https://docs.guitarswap.exchange/connection-guide", variant: "subtle", width: "100%" }, getExternalLinkProps()), "Learn How to Connect")))));
};
...
export { Icon$28 as AddIcon, Alert, Icon$27 as ArrowBackIcon, Icon$26 as ArrowDownIcon, Icon$25 as ArrowDropDownIcon, Icon$24 as ArrowDropUpIcon, Icon$23 as ArrowFirstIcon, Icon$22 as ArrowForwardIcon, Icon$21 as ArrowLastIcon, Icon$20 as ArrowUpIcon, Icon$1$ as AutoRenewIcon, BackgroundImage, BalanceInput, GridLayout$1 as BaseLayout, Icon$1Z as BinanceChainIcon, Icon$1_ as BinanceIcon, Icon$2a as BlockIcon, Icon$1Y as BnbUsdtPairTokenIcon, Box, Breadcrumbs, Icon$1X as BunnyCardsIcon, Icon$1W as BunnyPlaceholderIcon, Button, ButtonMenu$1 as ButtonMenu, ButtonMenuItem, Icon$1T as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$1U as CardViewIcon, Icon$1V as Cards, GridLayout as CardsLayout, Icon$1R as ChartIcon, Checkbox, Icon$1P as CheckmarkCircleFillIcon, Icon$2c as CheckmarkCircleIcon, Icon$1Q as CheckmarkIcon, Icon$1O as ChevronDownIcon, Icon$1N as ChevronLeftIcon, Icon$1M as ChevronRightIcon, Icon$1L as ChevronUpIcon, Icon$1S as CircleOutlineIcon, Icon$1K as CloseIcon, Icon$1J as CogIcon, Icon$1I as Coin98Icon, Icon$1H as CommunityIcon, ConnectorNames, Icon$1G as CopyIcon, Icon$1F as CrownIcon, Icon$1E as CurrencyIcon, Dropdown, Icon$1D as EllipsisIcon, Icon$2b as ErrorIcon, ExpandableButton, ExpandableLabel, FallingBunnies, Flex, Grid, Heading, Icon$1C as HelpIcon, Icon$1B as HistoryIcon, IconButton, Image, Icon$29 as InfoIcon, Input$1 as Input, InputGroup, Icon$1z as LanguageCurrencyIcon, Icon$1A as LanguageIcon, Icon$1y as LaurelLeftIcon, Icon$1x as LaurelRightIcon, Link, LinkExternal, Icon$1w as ListViewIcon, Icon$1v as LoginIcon, Icon$1u as LogoIcon, Icon$1t as LogoRoundIcon, Icon$1r as LogoutIcon, Icon$1s as MathWalletIcon, Icon$1q as MedalBronzeIcon, Icon$1p as MedalGoldIcon, Icon$1o as MedalPurpleIcon, Icon$1n as MedalSilverIcon, Icon$1m as MedalTealIcon, Menu$1 as Menu, Message, Icon$1l as MetamaskIcon, Icon$1k as MinusIcon, Modal, ModalBackButton, ModalBody, ModalCloseButton, ModalContainer, ModalHeader, ModalProvider, ModalTitle, Icon$1j as MoreHorizontalIcon, Icon$1i as MoreVerticalIcon, Icon$1h as NoProfileAvatarIcon, NotificationDot, Icon$1g as OpenNewIcon, Overlay, Icon$1d as PancakeRoundIcon, PancakeToggle, Icon$1f as PancakesIcon, Icon$1e as PencilIcon, Icon$1b as PlayCircleOutlineIcon, Icon$1c as PocketWatchIcon, Icon$1a as PredictionsIcon, Icon$14 as PresentCheckIcon, Icon$12 as PresentNoneIcon, Icon$13 as PresentWonIcon, Icon$19 as PrizeIcon, ProfileAvatar, Progress, Icon$15 as ProgressBunny, Icon$18 as ProposalIcon, Radio, Icon$11 as RefreshIcon, Icon$17 as RemoveIcon, ResetCSS, Icon$10 as SafePalIcon, Icon$$ as SearchIcon, Skeleton, Slider, Icon$_ as SmallDotIcon, Spinner, Icon$Z as StarFillIcon, Icon$Y as StarLineIcon, Step, Stepper, SubMenu, SubMenuItem, Svg, Icon$X as SwapIcon, Icon$W as SwapVertIcon, Icon$V as SyncAltIcon, Tab, ButtonMenu as TabMenu, Table, Tag, Td, Icon$U as TeamPlayerIcon, Icon$T as TestnetIcon, Text, Th, Icon$S as Ticket, Icon$R as TicketFillIcon, Icon$Q as TicketRound, Icon$P as TimerIcon, ToastContainer, Toggle, TokenImage, TokenPairImage, Icon$O as TokenPocketIcon, TooltipText, Icon$N as TrophyGoldIcon, Icon$M as TrustWalletIcon, Icon$L as TuneIcon, UserMenu, UserMenuDivider, UserMenuItem, Icon$16 as VerifiedIcon, Icon$K as VisibilityOff, Icon$J as VisibilityOn, Icon$I as VolumeOffIcon, Icon$H as VolumeUpIcon, Icon$G as VoteIcon, Icon$B as WaitIcon, Icon$E as WalletConnectIcon, Icon$C as WalletFilledIcon, Icon$D as WalletIcon, Icon$F as WarningIcon, variants$5 as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, status as menuStatus, types as toastTypes, useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useTooltip, useWalletModal };
